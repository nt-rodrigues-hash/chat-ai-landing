...
const AI_RESPONSES = {
  ...
  'custom properties':
    '**CSS Custom Properties** permitem reutilizar valores.\n\n' +
    '```css\n:root { --primary: #10a37f; }\n.button { background: var(--primary); }\n```\n\n' +
    'Você pode atualizar via JavaScript!',

  'melhores praticas':
    'Top 5 de melhores práticas:\n\n' +
...
Flexbox é um modelo de layout unidimensional.
...
Estilize baseado no tamanho do container!
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Restore last section (CHANGE: this must come AFTER sidebar state load)
...
function loadSidebarState() {
  // Already handled in initSidebar IIFE
}
